...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/virtualwebenv/virtualwebenv)


## Have a Question

If you have questions about how to use VirtualWebEnv, please direct your questions to the discussion on [Gitter](https://gitter.im/virtualwebenv/virtualwebenv/). If you believe your question could help others, then consider opening an [Issue](https://github.com/virtualwebenv/virtualwebenv/issues) (it will be labeled as `Question`) And you can still seek help on Gitter for it.
...
opening an [Issue](https://github.com/virtualwebenv/virtualwebenv/issues).
...
## Want a Feature
You can request a new feature by submitting an [Issue](https://github.com/virtualwebenv/virtualwebenv/issues) (it will be labeled as `Feature Suggestion`). If you would like to implement a new feature then consider submitting a Pull Request yourself.
...
VirtualWebEnv uses [Hugo](https://gohugo.io/) as website generator tool, with the [Material Docs theme](http://themes.gohugo.io/theme/material-docs/). You might need to check their docs quickly.
...
> The site will be auto-generated in the `docs/` folder by [Travis CI](https://travis-ci.org/virtualwebenv/virtualwebenv/).
...
*Most of the image in VirtualWebEnv are official images, these projects live in other repositories and maintainer by other organizations.*

**Note:** VirtualWebEnv has two base images for (`Workspace` and `php-fpm`, mainly made to speed up the build time on your machine.

* Find the dockerfiles, edit them and submit a Pull Request.

* When updating a VirtualWebEnv base image (`Workspace` or `php-fpm`), ask a project maintainer "Admin" to build a new image after your PR is merged.
...
* Search [GitHub](https://github.com/virtualwebenv/virtualwebenv/pulls) for an open or closed Pull Request that relates to your submission. You don't want to duplicate efforts.
...
* In GitHub, send a pull request to `VirtualWebEnv:master`.
